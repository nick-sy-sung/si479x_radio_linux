 ...
 *
 * @author Michael.Yi@skyworksinc.com
*/
...
////////////////////////////////////////////////////////
typedef uint8_t PIN_GROUP; enum
{
    PIN_FLASH = 1,
    PIN_ZIF0,
    PIN_ZIF1,
...
typedef uint8_t ADC_SOURCE_PINS; enum
{
    AIN0,
    AIN1,
    AIN2,
...
typedef uint8_t ADC_GAINS; enum
{
    ADC_0DB,
    ADC_3DB,
    ADC_6DB,
...
////////////////////////////////////////////////////////
typedef uint8_t SAMPLE_RATE; enum
{
	FS8KS = 0x01,
	FS12KS,
	FS16KS,
...
typedef uint8_t WHITENCONTROL; enum
{
	DEFAULT,
	WHITEN10,
	WHITEN20,
...
typedef uint8_t SLOT_SIZE, SAMPLE_SIZE; enum
{
	EIGHT,
	SIXTEEN,
	TWENTY,
...
typedef uint8_t BITORDER; enum
{
	MSBFIRST,
	LSBFIRST
};

typedef uint8_t SWAP; enum
{
	LEFTRIGHT,
	RIGHTLEFT
};
...
typedef uint8_t CLKINV; enum
{
	CLK_NORMAL,
	CLK_INVERTED
};

typedef uint8_t FRAMING_MODE; enum
{
	I2S,
	DSP = 0x6,
};

typedef uint8_t CLOCK_DOMAIN; enum
{
	AUDIOSYNTH
};
...
typedef uint8_t PORT_MODE; enum
{
    PORT_QUERY,
    PORT_RELEASE,
    PORT_DISABLE,
...
typedef uint8_t PORT_CURRENT_MODE; enum
{
    QUERY,
    DISABLE,
    ENABLE
